...
<<<<<<< HEAD
            ...
            # if type(sources[0]['conversations'][1]['value']) == float:
            #     print(f"[Eror]: gpt response of id {sources[0]['id']} conversations is NaN")
            #     import random
            #     return random.choice(self)
...
=======
            ...
            sources = preprocess_multimodal(
                ...
                self.data_args)            
        elif 'image_path' in sources[0]:
            image_path = self.list_data_dict[i]['image_path']
            processor = self.data_args.image_processor
...
=======
        if 'image' in self.list_data_dict[i] or 'image_path' in self.list_data_dict[i]:
>>>>>>> 276aad72915e5e117afb85653e76ea80dead1157
