...
class Conversation:
    ...
    def get_prompt(self):
        ...
        if not self.has_image:
            ret = ret.replace("<Image><image></Image>", "") if 'mmtag' in self.version else ret.replace("<image>\n", "")
        return ret
...
# roles=("<|start_header_id|>user<|end_header_id|>\n\nCaption:", "<|start_header_id|>assistant<|end_header_id|>\n\n"),
#     version="llama3_qa",
#     messages=(),
#     offset=0,
#     sep_style=SeparatorStyle.MPT,
...
conv_llama3_qa = Conversation(
    ...
    roles=("<|start_header_id|>user<|end_header_id|>\n\nFine-grained caption: ", "<|start_header_id|>assistant<|end_header_id|>\n\n"),
    version="llama3_qa",
    messages=(),
    offset=0,
    sep_style=SeparatorStyle.MPT,
