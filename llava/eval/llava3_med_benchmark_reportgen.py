    ...
    def __call__(self, prompts):
        ...
        with torch.inference_mode():
            output_ids = self.model.generate(
                inputs_ids.to(device='cuda', non_blocking=True),
...
if __name__ == "__main__":
    ...
    engine = MultiMedEval()
    setupParams = SetupParams(**json.load(open("./scripts/multi_med_eval.json")))
    ...
    engine.eval(["MIMIC-CXR Report Generation"], batcher, EvalParams(batch_size=32, run_name="testLLaVAMed3"))
