...
<<<<<<< HEAD
        print(prompts)
=======
>>>>>>> 276aad72915e5e117afb85653e76ea80dead1157
        outputList = []
        listText = []
        listImage = []
        listImageSize = []
...
<<<<<<< HEAD
        ...
        input_ids = self.pad_sequence(
            input_ids,
=======
        inputs = [tokenizer_image_token(prompt, self.tokenizer, IMAGE_TOKEN_INDEX, return_tensors='pt').unsqueeze(0) for prompt in listText]
...
<<<<<<< HEAD
    setupParams = SetupParams(MNIST_Oct_dir="/data1/yunfei/EvalData/MNIST_Oct")
=======
<<<<<<< HEAD
    setupParams = SetupParams(**json.load(open("/home/ec2-user/disk/llava_med/llava3-med/scripts/multi_med_eval.json")))
=======
    setupParams = SetupParams(**json.load(open("/data3/yunfei/llava3-med/scripts/med/multi_med_eval.json")))
>>>>>>> 77ef6f8b31c32f7220e0f8bc7511b5b9d27486a2
>>>>>>> 276aad72915e5e117afb85653e76ea80dead1157
    try: 
...
<<<<<<< HEAD
    engine.eval(["OCTMNIST"], batcher, EvalParams(batch_size=2, run_name="testLLaVAMed3"))
=======
<<<<<<< HEAD
    engine.eval(["abc"], batcher, EvalParams(batch_size=2, run_name="testLLaVAMed3"))
=======
    # engine._config["MIMIC_CXR_dir"] = "/data3/yunfei/EvalData/mimic-cxr-jpg"
    engine.eval(["CBIS-DDSM Mass", "PathMNIST", "PneumoniaMNIST", "RetinaMNIST", "BloodMNIST", "ChestMNIST", "OrganAMNIST", "OrganCMNIST", "OrganSMNIST", "DermaMNIST", "BreastMNIST", "TissueMNIST"], batcher, EvalParams(batch_size=128, run_name="testLLaVAMed3_wo"))
    # engine.eval(["CBIS-DDSM Mass", "CBIS-DDSM Calcification", "Pad UFES 20"], batcher, EvalParams(batch_size=128, run_name="testLLaVAMed3"))
    # engine.eval(["Pad UFES 20"], batcher, EvalParams(batch_size=64, run_name="testLLaVAMed3"))
>>>>>>> 77ef6f8b31c32f7220e0f8bc7511b5b9d27486a2
>>>>>>> 276aad72915e5e117afb85653e76ea80dead1157
